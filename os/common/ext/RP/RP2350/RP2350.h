 ...
 *
 * @file     /home/karlk/Development/qmk_firmware_2/lib/chibios/os/common/ext/RP/RP2350/sources/../RP2350.h
 * @brief    CMSIS HeaderFile
 * @version  0.1
 * @date     Mon Sep  2 23:18:24 2024
 ...
 *           last modified on Mon Sep  2 23:18:16 2024
 */
...
/**
  * @brief TICKS_TICK [TICK] (Cluster TICK, containing *_CTRL, *_CYCLES, *_COUNT)
  */
typedef struct {
  __IOM uint32_t  CTRL;                         /*!< Controls the tick generator                                               */
  __IOM uint32_t  CYCLES;                       /*!< CYCLES                                                                    */
  __IOM uint32_t  COUNT;                        /*!< COUNT                                                                     */
} TICKS_TICK_Type;                              /*!< Size = 12 (0xc)                                                           */


/**
  * @brief IO_QSPI_GPIO_QSPI [GPIO_QSPI] (Cluster GPIO_QSPI, containing GPIO_QSPI_*_STATUS, GPIO_QSPI_*_CTRL)
  */
typedef struct {
  __IOM uint32_t  GPIO_STATUS;                  /*!< GPIO_STATUS                                                               */
  __IOM uint32_t  GPIO_CTRL;                    /*!< GPIO_CTRL                                                                 */
} IO_QSPI_GPIO_QSPI_Type;                       /*!< Size = 8 (0x8)                                                            */


/**
  * @brief IO_BANK0_GPIO [GPIO] (Cluster GPIO, containing GPIO*_STATUS, GPIO*_CTRL)
  */
typedef struct {
  __IOM uint32_t  GPIO_STATUS;                  /*!< GPIO_STATUS                                                               */
  __IOM uint32_t  GPIO_CTRL;                    /*!< GPIO_CTRL                                                                 */
} IO_BANK0_GPIO_Type;                           /*!< Size = 8 (0x8)                                                            */


/**
  * @brief DMA_CH [CH] (Cluster CH, containing CH?_READ_ADDR,CH??_READ_ADDR, CH?_WRITE_ADDR,CH??_WRITE_ADDR, CH?_TRANS_COUNT,CH??_TRANS_COUNT, CH?_CTRL_TRIG,CH??_CTRL_TRIG, CH?_AL1_CTRL,CH??_AL1_CTRL, CH?_AL1_READ_ADDR,CH??_AL1_READ_ADDR, CH?_AL1_WRITE_ADDR,CH??_AL1_WRITE_ADDR, CH?_AL1_TRANS_COUNT_TRIG,CH??_AL1_TRANS_COUNT_TRIG, CH?_AL2_CTRL,CH??_AL2_CTRL, CH?_AL2_TRANS_COUNT,CH??_AL2_TRANS_COUNT, CH?_AL2_READ_ADDR,CH??_AL2_READ_ADDR, CH?_AL2_WRITE_ADDR_TRIG,CH??_AL2_WRITE_ADDR_TRIG, CH?_AL3_CTRL,CH??_AL3_CTRL, CH?_AL3_WRITE_ADDR,CH??_AL3_WRITE_ADDR, CH?_AL3_TRANS_COUNT,CH??_AL3_TRANS_COUNT, CH?_AL3_READ_ADDR_TRIG,CH??_AL3_READ_ADDR_TRIG)
  */
typedef struct {
  __IOM uint32_t  CH_READ_ADDR;                 /*!< DMA Channel 0 Read Address pointer                                        */
  __IOM uint32_t  CH_WRITE_ADDR;                /*!< DMA Channel 0 Write Address pointer                                       */
  __IOM uint32_t  CH_TRANS_COUNT;               /*!< DMA Channel 0 Transfer Count                                              */
  __IOM uint32_t  CH_CTRL_TRIG;                 /*!< DMA Channel 0 Control and Status                                          */
  __IOM uint32_t  CH_AL1_CTRL;                  /*!< DMA Channel 0 Control and Status                                          */
  __IOM uint32_t  CH_AL1_READ_ADDR;             /*!< Alias for channel 0 READ_ADDR register                                    */
  __IOM uint32_t  CH_AL1_WRITE_ADDR;            /*!< Alias for channel 0 WRITE_ADDR register                                   */
  __IOM uint32_t  CH_AL1_TRANS_COUNT_TRIG;      /*!< Alias for channel 0 TRANS_COUNT register This is a trigger register
                                                     (0xc). Writing a nonzero value will reload the channel
                                                     counter and start the channel.                                            */
  __IOM uint32_t  CH_AL2_CTRL;                  /*!< DMA Channel 0 Control and Status                                          */
  __IOM uint32_t  CH_AL2_TRANS_COUNT;           /*!< Alias for channel 0 TRANS_COUNT register                                  */
  __IOM uint32_t  CH_AL2_READ_ADDR;             /*!< Alias for channel 0 READ_ADDR register                                    */
  __IOM uint32_t  CH_AL2_WRITE_ADDR_TRIG;       /*!< Alias for channel 0 WRITE_ADDR register This is a trigger register
                                                     (0xc). Writing a nonzero value will reload the channel
                                                     counter and start the channel.                                            */
  __IOM uint32_t  CH_AL3_CTRL;                  /*!< DMA Channel 0 Control and Status                                          */
  __IOM uint32_t  CH_AL3_WRITE_ADDR;            /*!< Alias for channel 0 WRITE_ADDR register                                   */
  __IOM uint32_t  CH_AL3_TRANS_COUNT;           /*!< Alias for channel 0 TRANS_COUNT register                                  */
  __IOM uint32_t  CH_AL3_READ_ADDR_TRIG;        /*!< Alias for channel 0 READ_ADDR register This is a trigger register
                                                     (0xc). Writing a nonzero value will reload the channel
                                                     counter and start the channel.                                            */
} DMA_CH_Type;                                  /*!< Size = 64 (0x40)                                                          */


/**
  * @brief PWM_CH [CH] (Cluster CH, containing CH*_CC, CH*_CSR, CH*_CTR, CH*_DIV, CH*_TOP)
  */
typedef struct {
  __IOM uint32_t  CSR;                          /*!< Control and status register                                               */
  __IOM uint32_t  DIV;                          /*!< INT and FRAC form a fixed-point fractional number. Counting
                                                     rate is system clock frequency divided by this number.
                                                     Fractional division uses simple 1st-order sigma-delta.                    */
  __IOM uint32_t  CTR;                          /*!< Direct access to the PWM counter                                          */
  __IOM uint32_t  CC;                           /*!< Counter compare values                                                    */
  __IOM uint32_t  TOP;                          /*!< Counter wrap value                                                        */
} PWM_CH_Type;                                  /*!< Size = 20 (0x14)                                                          */


/**
  * @brief PIO0_SM [SM] (Cluster SM, containing SM*_CLKDIV, SM*_EXECCTRL, SM*_SHIFTCTRL, SM*_ADDR, SM*_INSTR, SM*_PINCTRL)
  */
typedef struct {
  __IOM uint32_t  SM_CLKDIV;                    /*!< Clock divisor register for state machine 0 Frequency = clock
                                                     freq / (CLKDIV_INT + CLKDIV_FRAC / 256)                                   */
  __IOM uint32_t  SM_EXECCTRL;                  /*!< Execution/behavioural settings for state machine 0                        */
  __IOM uint32_t  SM_SHIFTCTRL;                 /*!< Control behaviour of the input/output shift registers for state
                                                     machine 0                                                                 */
  __IOM uint32_t  SM_ADDR;                      /*!< Current instruction address of state machine 0                            */
  __IOM uint32_t  SM_INSTR;                     /*!< Read to see the instruction currently addressed by state machine
                                                     0's program counter Write to execute an instruction immediately
                                                     (including jumps) and then resume execution.                              */
  __IOM uint32_t  SM_PINCTRL;                   /*!< State machine pin control                                                 */
} PIO0_SM_Type;                                 /*!< Size = 24 (0x18)                                                          */


/**
  * @brief PIO0_SM_IRQ [SM_IRQ] (Cluster SM_IRQ, containing IRQ*_INTE, IRQ*_INTF, IRQ*_INTS)
  */
typedef struct {
  __IOM uint32_t  IRQ_INTE;                     /*!< Interrupt Enable for irq0                                                 */
  __IOM uint32_t  IRQ_INTF;                     /*!< Interrupt Force for irq0                                                  */
  __IOM uint32_t  IRQ_INTS;                     /*!< Interrupt status after masking & forcing for irq0                         */
} PIO0_SM_IRQ_Type;                             /*!< Size = 12 (0xc)                                                           */
...
typedef struct {                                /*!< TICKS Structure                                                           */
  __IOM TICKS_TICK_Type TICK[6];                /*!< Cluster TICK, containing *_CTRL, *_CYCLES, *_COUNT                        */
...
typedef struct {                                /*!< PADS_BANK0 Structure                                                      */
  ...
  __IOM uint32_t  GPIO0;                        /*!< 0                                                                         */
  __IOM uint32_t  GPIO1;                        /*!< 1                                                                         */
  __IOM uint32_t  GPIO2;                        /*!< 2                                                                         */
  __IOM uint32_t  GPIO3;                        /*!< 3                                                                         */
  __IOM uint32_t  GPIO4;                        /*!< 4                                                                         */
  __IOM uint32_t  GPIO5;                        /*!< 5                                                                         */
  __IOM uint32_t  GPIO6;                        /*!< 6                                                                         */
  __IOM uint32_t  GPIO7;                        /*!< 7                                                                         */
  __IOM uint32_t  GPIO8;                        /*!< 8                                                                         */
  __IOM uint32_t  GPIO9;                        /*!< 9                                                                         */
  __IOM uint32_t  GPIO10;                       /*!< 10                                                                        */
  __IOM uint32_t  GPIO11;                       /*!< 11                                                                        */
  __IOM uint32_t  GPIO12;                       /*!< 12                                                                        */
  __IOM uint32_t  GPIO13;                       /*!< 13                                                                        */
  __IOM uint32_t  GPIO14;                       /*!< 14                                                                        */
  __IOM uint32_t  GPIO15;                       /*!< 15                                                                        */
  __IOM uint32_t  GPIO16;                       /*!< 16                                                                        */
  __IOM uint32_t  GPIO17;                       /*!< 17                                                                        */
  __IOM uint32_t  GPIO18;                       /*!< 18                                                                        */
  __IOM uint32_t  GPIO19;                       /*!< 19                                                                        */
  __IOM uint32_t  GPIO20;                       /*!< 20                                                                        */
  __IOM uint32_t  GPIO21;                       /*!< 21                                                                        */
  __IOM uint32_t  GPIO22;                       /*!< 22                                                                        */
  __IOM uint32_t  GPIO23;                       /*!< 23                                                                        */
  __IOM uint32_t  GPIO24;                       /*!< 24                                                                        */
  __IOM uint32_t  GPIO25;                       /*!< 25                                                                        */
  __IOM uint32_t  GPIO26;                       /*!< 26                                                                        */
  __IOM uint32_t  GPIO27;                       /*!< 27                                                                        */
  __IOM uint32_t  GPIO28;                       /*!< 28                                                                        */
  __IOM uint32_t  GPIO29;                       /*!< 29                                                                        */
  __IOM uint32_t  GPIO30;                       /*!< 30                                                                        */
  __IOM uint32_t  GPIO31;                       /*!< 31                                                                        */
  __IOM uint32_t  GPIO32;                       /*!< 32                                                                        */
  __IOM uint32_t  GPIO33;                       /*!< 33                                                                        */
  __IOM uint32_t  GPIO34;                       /*!< 34                                                                        */
  __IOM uint32_t  GPIO35;                       /*!< 35                                                                        */
  __IOM uint32_t  GPIO36;                       /*!< 36                                                                        */
  __IOM uint32_t  GPIO37;                       /*!< 37                                                                        */
  __IOM uint32_t  GPIO38;                       /*!< 38                                                                        */
  __IOM uint32_t  GPIO39;                       /*!< 39                                                                        */
  __IOM uint32_t  GPIO40;                       /*!< 40                                                                        */
  __IOM uint32_t  GPIO41;                       /*!< 41                                                                        */
  __IOM uint32_t  GPIO42;                       /*!< 42                                                                        */
  __IOM uint32_t  GPIO43;                       /*!< 43                                                                        */
  __IOM uint32_t  GPIO44;                       /*!< 44                                                                        */
  __IOM uint32_t  GPIO45;                       /*!< 45                                                                        */
  __IOM uint32_t  GPIO46;                       /*!< 46                                                                        */
  __IOM uint32_t  GPIO47;                       /*!< 47                                                                        */
...
typedef struct {                                /*!< IO_QSPI Structure                                                         */
  ...
  __IOM IO_QSPI_GPIO_QSPI_Type GPIO_QSPI[6];    /*!< Cluster GPIO_QSPI, containing GPIO_QSPI_*_STATUS, GPIO_QSPI_*_CTRL        */
...
typedef struct {                                /*!< IO_BANK0 Structure                                                        */
  __IOM IO_BANK0_GPIO_Type GPIO[48];            /*!< Cluster GPIO, containing GPIO*_STATUS, GPIO*_CTRL                         */
...
typedef struct {                                /*!< DMA Structure                                                             */
  __IOM DMA_CH_Type CH[16];                     /*!< Cluster CH, containing CH?_READ_ADDR,CH??_READ_ADDR, CH?_WRITE_ADDR,CH??_WRITE
                                                     ADDR, CH?_TRANS_COUNT,CH??_TRANS_COUNT, CH?_CTRL_TRIG,CH??_CTRL_TRIG,
                                                     CH?_AL1_CTRL,CH??_AL1_CTRL, CH?_AL1_READ_ADDR,CH??_AL1_READ_ADDR,
                                                     CH?_AL1_WRITE_ADDR,CH??_AL1_WRITE_ADDR, CH?_AL1_TRANS_COUNT_TRIG,CH??_AL1
                                                     TRANS_COUNT_TRIG, CH?_AL2_CTRL,CH??_AL2_CTRL, CH?_AL2_TRANS_COUNT,CH??_AL
                                                     _TRANS_COUNT, CH?_AL2_READ_ADDR,CH??_AL2_READ_ADDR, CH?_AL2_WRITE_ADDR_TR
                                                     G,CH??_AL2_WRITE_ADDR_TRIG, CH?_AL3_CTRL,CH??_AL3_CTRL,
                                                     CH?_AL3_WRITE_ADDR,CH??_AL3_WRITE_ADDR, CH?_AL3_TRANS_COUNT,CH??_AL3_TRAN
                                                     _COUNT, CH?_AL3_READ_ADDR_TRIG,CH??_AL3_READ_ADDR_TRIG                    */
...
typedef struct {                                /*!< PWM Structure                                                             */
  __IOM PWM_CH_Type CH[12];                     /*!< Cluster CH, containing CH*_CC, CH*_CSR, CH*_CTR, CH*_DIV, CH*_TOP         */
...
typedef struct {                                /*!< PIO0 Structure                                                            */
  ...
  __IOM PIO0_SM_Type SM[4];                     /*!< Cluster SM, containing SM*_CLKDIV, SM*_EXECCTRL, SM*_SHIFTCTRL,
                                                     SM*_ADDR, SM*_INSTR, SM*_PINCTRL                                          */
  ...
  __IOM uint32_t  INTR;                         /*!< Raw Interrupts                                                            */
  __IOM PIO0_SM_IRQ_Type SM_IRQ[2];             /*!< Cluster SM_IRQ, containing IRQ*_INTE, IRQ*_INTF, IRQ*_INTS                */
...
typedef struct {                                /*!< SIO Structure                                                             */
  ...
  __IOM uint32_t  INTERP1_BASE_1AND0;           /*!< On write, the lower 16 bits go to BASE0, upper bits to BASE1
                                                     simultaneously. Each half is sign-extended to 32 bits if
                                                     that lane's SIGNED flag is set.                                           */
  __IOM uint32_t  SPINLOCK[32];                 /*!< Reading from a spinlock address will: - Return 0 if lock is
...
typedef struct {                                /*!< USB Structure                                                             */
  ...
  __IOM uint32_t  HOST_ADDR_ENDP[15];           /*!< Interrupt endpoints. Only valid in HOST mode.                             */
...
typedef struct {                                /*!< USB_DPRAM Structure                                                       */
  ...
  __IOM uint32_t  EP_CONTROL[30];               /*!< TODO                                                                      */
  __IOM uint32_t  EP_BUFFER_CONTROL[32];        /*!< TODO                                                                      */
